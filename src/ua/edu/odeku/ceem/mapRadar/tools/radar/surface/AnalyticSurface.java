...
/**
 * AnalyticSurface represents a connected grid of geographic locations, covering a specified {@link gov.nasa.worldwind.geom.Sector} at a
...
public class AnalyticSurface implements Renderable, PreRenderable
{
    ...
    /**
     * Constructs a new AnalyticSurface with the specified {@link gov.nasa.worldwind.geom.Sector}, base altitude in meters, grid dimensions, and
    ...
    /**
     * Constructs a new AnalyticSurface with the specified {@link gov.nasa.worldwind.geom.Sector}, base altitude in meters, and grid dimensions.
    ...
    /**
     * Constructs a new AnalyticSurface with the specified {@link gov.nasa.worldwind.geom.Sector} and base altitude in meters. The new
     ...
     * Sector {@link gov.nasa.worldwind.geom.Sector#EMPTY_SECTOR}, the default altitude of 0 meters, and default {@link GridPointAttributes}.
     *
     * @param width  the surface grid width, in number of grid points.
     * @param height the surface grid height, in number of grid points.
     *
    ...
    /**
     * Constructs a new AnalyticSurface with the default Sector {@link gov.nasa.worldwind.geom.Sector#EMPTY_SECTOR}, the default altitude of 0
    ...
    /**
     * Returns the {@link gov.nasa.worldwind.geom.Sector} defining the geographic boundary of this surface.
     *
    ...
    /**
     * Sets this surface's geographic boundary, as a {@link gov.nasa.worldwind.geom.Sector}.
     *
     ...
     * {@link gov.nasa.worldwind.util.BufferWrapper}. Values equivalent to the specified <code>missingDataSignal</code> are replaced with the
