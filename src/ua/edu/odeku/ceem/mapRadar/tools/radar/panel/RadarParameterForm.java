...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("label_uk_UA").getString("airspace_name"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("label_uk_UA").getString("airspace_altitude"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("label_uk_UA").getString("airspace_durationPulse"));
        ...
        this.$$$loadLabelText$$$(label4, ResourceBundle.getBundle("label_uk_UA").getString("airspace_wavelength"));
        attributePanel.add(label4, cc.xy(1, 6));
        final JLabel label5 = new JLabel();
        this.$$$loadLabelText$$$(label5, ResourceBundle.getBundle("label_uk_UA").getString("airspace_antennaDiameter"));
        attributePanel.add(label5, cc.xy(1, 8));
        final JLabel label6 = new JLabel();
        this.$$$loadLabelText$$$(label6, ResourceBundle.getBundle("label_uk_UA").getString("airspace_pulsePower"));
        ...
        this.$$$loadLabelText$$$(label7, ResourceBundle.getBundle("label_uk_UA").getString("airspace_reflectivityMeteoGoals"));
        attributePanel.add(label7, cc.xy(1, 12));
        final JLabel label8 = new JLabel();
        this.$$$loadLabelText$$$(label8, ResourceBundle.getBundle("label_uk_UA").getString("airspace_attenuation"));
        attributePanel.add(label8, cc.xy(1, 14));
        final JLabel label9 = new JLabel();
        this.$$$loadLabelText$$$(label9, ResourceBundle.getBundle("label_uk_UA").getString("airspace_radius"));
        attributePanel.add(label9, cc.xy(1, 16));
        final JLabel label10 = new JLabel();
        this.$$$loadLabelText$$$(label10, ResourceBundle.getBundle("label_uk_UA").getString("airspace_grainFactor"));
